...
import {FaPlusCircle,FaPlus,FaBookmark,FaRegBookmark,FaHeart,FaRegHeart,FaImages,FaRegComment,FaRegTrashAlt,FaRegEdit,FaUserPlus,FaUserMinus} from "react-icons/fa"
...
const UnFollowUser=chakra(FaUserMinus);
export {
    RightIcon,
    LeftIcon,
    ShowPasswordIcon,
